...
async function resolvePage(page, config, fetchImpl) {
  const body = { bridge_record: {
    ...
    adapter_id: "hugo-discussion-bridge", adapter_version: "0.1.0-alpha.7",
